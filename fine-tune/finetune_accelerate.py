...
def load_dataset(
    input_file, input_test_file, input_dg_file=None, val=True, dev=False
) -> pd.DataFrame:
    ...
    if input_dg_file:
        ...
        dg["source_text"] = (
            ...
            + dg["Assessment"]
            + " <SUBJECTIVE> "
            + dg["Subjective Sections"]
            + " <OBJECTIVE> "
            + dg["Objective Sections"]
        )
    ...
    test_df["source_text"] = (
        ...
        + test_df["Assessment"]
        + " <SUBJECTIVE> "
        + test_df["Subjective Sections"]
        + " <OBJECTIVE> "
        + test_df["Objective Sections"]
    )
    ...
    df["source_text"] = (
        ...
        + df["Assessment"]
        + " <SUBJECTIVE> "
        + df["Subjective Sections"]
        + " <OBJECTIVE> "
        + df["Objective Sections"]
    )
